...
if(meal==null){
  ...
  meal.forEach(meal=>{
    ...
    <div class="meal">
    <img onClick="foodDetails('${meal.idMeal}')"class="img" src="${meal.strMealThumb}" alt="${meal.strMeal}"/>
